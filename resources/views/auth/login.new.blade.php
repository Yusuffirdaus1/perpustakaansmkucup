<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center bg-gradient-to-br from-blue-600 to-blue-800">
        <div class="w-full sm:max-w-2xl bg-white p-8 rounded-xl shadow-2xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Left Side - Welcome Text -->
                <div class="flex flex-col justify-center space-y-6">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">Selamat Datang</h2>
                        <p class="mt-3 text-gray-600">Masuk ke Perpustakaan Digital SMK 65</p>
                    </div>
